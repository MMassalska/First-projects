...
##### *Pixar ID is `r pixar_id`.*

# Part 3

### Preparing a list with all Pixar movies in the order of desceding revenue.

+ Writing a query that gives all the Pixar movies and sort them by descending revenue.
...
##### *From obtained t-test we received the p-value equal to `r p_value_company`. Which means that there is a relation between avarage votes and company.*
